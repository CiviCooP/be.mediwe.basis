...
/**
 * Ziekmelding.Update API specification (optional)
 ...
 */
function _civicrm_api3_ziektemelding_Update_spec(&$spec) {
  $spec['id'] = array(
    'name' => 'id',
    'title' => 'case_id',
  ...
  $spec['subject'] = array(
    'name' => 'subject',
    'title' => 'Dossier onderwerp',
    'description' => 'Onderwerp van het dossier ziektemelding',
    'api.required' => 0,
  ...
  $spec['mzp_opmerkingen'] = array(
    'name' => 'mzp_opmerkingen',
    'title' => 'Opmerkingen',
