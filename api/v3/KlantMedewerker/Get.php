...
/**
 * KlantMedewerker.Get API specification (optional)
 ...
 */
function _civicrm_api3_klant_medewerker_Get_spec(&$spec) {
  $spec['id'] = array(
    'name' => 'id',
 ...
 */
function civicrm_api3_klant_medewerker_Get($params) {
  $klantMedewerker = new CRM_Basis_KlantMedewerker();
  $returnValues = $klantMedewerker->get($params);
  return civicrm_api3_create_success($returnValues, $params, 'KlantMedewerker', 'Get');
}
