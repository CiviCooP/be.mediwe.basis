...
/**
 * Klant.Get API specification (optional)
 ...
 */
function _civicrm_api3_klant_Get_spec(&$spec) {
  $spec['id'] = array(
    'name' => 'id',
    'title' => 'id klant',
    'description' => 'ID klant',
    'api.required' => 0,
  ...
  $spec['limit'] = array(
    'name' => 'limit',
    'title' => 'limit',
    'description' => 'maximaal aantal klanten ophalen (standaard = 25)',
    'api.required' => 0,
    'type' => CRM_Utils_Type::T_INT,
  );
}
 ...
 */
function civicrm_api3_klant_Get($params) {
  $klant = new CRM_Basis_Klant();
  return civicrm_api3_create_success($klant->get($params), $params, 'Klant', 'Get');
}
